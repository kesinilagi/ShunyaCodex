...
.thought-ball-wrapper.meditation-recede {
    animation: meditationScaleOut 17s forwards; /* Terapkan animasi skala keluar */
}

.thought-ball-wrapper.meditation-vanish {
    animation: meditationVanishOut 12s forwards; /* === PERUBAHAN: Durasi menjadi 15 detik === */
